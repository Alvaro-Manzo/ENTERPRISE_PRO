...
![License](https://img.shields.io/badge/Licencia-MIT-red.svg)
![Status](https://img.shields.io/badge/Estado-Listo--Producción-brightgreen.svg)
...
```mermaid
graph TB
    A[Frontend SPA] --> B[Servidor API Flask]
    B --> C[Capa de Autenticación]
    B --> D[Lógica de Negocio]
    D --> E[Base de Datos SQLite]
    C --> F[Gestor de Tokens JWT]
    D --> G[Sistema de Permisos]
```
